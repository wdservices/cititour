...
const socialPlatforms = [
  ...
  { name: "Email", icon: Mail, color: "bg-gray-600", shareUrl: "mailto:?subject=Check out Garden City Explore&body=" }
];
...
const ShareAppPage = () => {
  ...
  const referralLink = `https://gardencityexplore.com/join?ref=${referralCode}`;
  ...
  const shareToSocial = (platform: typeof socialPlatforms[0]) => {
    const message = `🌟 Discover amazing places in Garden City with Garden City Explore! Join me and get exclusive deals. Use my referral code: ${referralCode} ${referralLink}`;
      ...
      <div className="bg-gradient-primary text-white py-8">
        <div className="px-4">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">Share Garden City Explore</h1>
      ...
      <div className="px-4 py-6 max-w-4xl mx-auto">
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Earn amazing rewards for every friend you bring to Garden City Explore
            </CardDescription>
          </CardHeader>
          <CardContent>
