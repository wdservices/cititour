        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-foreground/90">
            <section>
              ...
              <p>
                By accessing or using Citivas ("the Platform"), you agree to these Terms of Use. If you do not agree, please discontinue use immediately.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-3">
                Citivas is Nigeria's urban concierge platform. The Platform enables you to:
              </p>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>You must be at least 13 years old to use Citivas.</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Citivas reserves the right to remove listings that violate these Terms or community guidelines.</li>
                <li>You retain ownership of content you submit, but grant Citivas a license to display, distribute, and promote it on the Platform.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>The Marketplace connects buyers and sellers. Citivas is not a party to any transaction between buyers and sellers.</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>When you register for a paid event, your payment is processed through Paystack. Citivas does not store your card details.</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Citivas offers a digital wallet that can be funded via Paystack (card, bank transfer, or USSD).</li>
                ...
                <li>Citivas is not responsible for delays caused by Paystack or your bank.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Citivas may remove reviews that violate these Terms.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                All content, design, logos, and software on Citivas are protected by intellectual property laws. You may not copy, distribute, modify, or create derivative works from any content on the Platform without prior written permission.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                To the maximum extent permitted by Nigerian law, Citivas, its operators, and affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Platform, including but not limited to loss of data, revenue, or profits.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We may suspend or terminate your access to Citivas at any time, without prior notice, for conduct that we believe violates these Terms, is harmful to other users, or is for security reasons. You may also delete your account at any time from the Settings page.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We may update these Terms from time to time. Continued use of Citivas after changes are posted constitutes your acceptance of the updated Terms. We will notify users of material changes through the Platform or by email.
              </p>
            </section>
