...
const menuItems = [
  ...
  { icon: Building, label: 'Business Listings', path: '/admin/business-listings' },
  { icon: Calendar, label: 'Events', path: '/admin/events' },
  { icon: Home, label: 'Properties', path: '/admin/properties' },
  { icon: UtensilsCrossed, label: 'Mini Websites', path: '/admin/mini-sites' },
  ...
  { icon: Wallet, label: 'Wallet & Revenue', path: '/admin/wallet' },
  { icon: QrCode, label: 'QR Validate', path: '/admin/qr-validate' },
