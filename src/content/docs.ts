...
export const DOC_SECTIONS: DocSection[] = [
  ...
  },
  {
    ...
    icon: '🛡️',
    description: 'Google Play Child Safety Standards policy compliance for Citivas.',
    topics: [
      {
        id: 'child-safety-overview',
        title: 'Child Safety Standards Policy',
        description: 'Google Play takes seriously the safety of children on our platform and is committed to working to keep our store free of child sexual abuse and exploitation. We require Anonymous and Random Chat apps, and apps in the Social and Dating categories to comply with our Child Safety Standards policy.',
        steps: [
          ...
          'Make sure to read the policy in full and ensure you understand and comply.',
          'Developers who are not in compliance by the deadline may be subject to enforcement actions.',
          'For more guidance, check out Tech Coalition\'s best practices for Combating Online CSEA.',
        ],
      },
      {
        id: 'csae-definition',
        title: 'What is CSAE?',
        description: 'CSAE refers to child sexual abuse and exploitation, including content or behavior that sexually exploits, abuses, or endangers children.',
        steps: [
          'CSAE includes, for example:',
      ...
      },
      {
        id: 'csam-definition',
        title: 'What is CSAM?',
        description: 'Child Sexual Abuse Material (CSAM) refers to any content that depicts the sexual abuse or exploitation of children.',
        steps: [
          'CSAM is illegal and strictly prohibited on Citivas.',
          'Any content that depicts minors in sexual situations is considered CSAM.',
          'This includes images, videos, text, and digital representations.',
        ],
      },
      {
        id: 'csae-standards',
        title: 'Requirements for CSAE Published Standards',
        description: 'What the published standards must include.',
        steps: [
          'Your published standards must clearly state:',
          '  • A zero-tolerance policy against child sexual abuse and exploitation.',
          '  • The types of behavior and content that are prohibited.',
          '  • The consequences for violating these standards.',
      ...
      },
      {
        ...
        description: 'What kinds of in-app mechanisms should my app have for user feedback?',
        steps: [
          'Apps must provide an easily accessible in-app mechanism for users to:',
          '  • Report content or behavior that may constitute CSAE or CSAM.',
          '  • Report suspicious interactions with minors.',
          '  • Submit feedback related to child safety concerns.',
          'Users should be able to report through the app — email or web forms alone are not sufficient.',
          'Reports must be reviewed and acted upon in a timely manner.',
        ],
        tips: [
          'Citivas provides an in-app Feedback system and Contact Support page for reporting.',
          'All reports are reviewed by our safety team.',
        ],
      },
      {
        id: 'csam-action',
        title: 'Taking Appropriate Action on CSAM',
        description: 'What it means to take "appropriate action" to address CSAM.',
        steps: [
          'When CSAM is identified, apps must:',
          '  • Immediately remove the content.',
          '  • Report the content to the relevant authorities (e.g., NCMEC in the US, or local equivalents).',
          '  • Terminate the accounts of users who shared or created the material.',
          '  • Preserve evidence for law enforcement.',
          '  • Cooperate fully with investigations.',
        ],
      },
      {
        id: 'child-safety-laws',
        title: 'Compliance with Child Safety Laws',
        description: 'Apps must comply with applicable child safety laws in the jurisdictions they operate.',
        steps: [
          'This includes compliance with laws such as:',
          '  • COPPA (Children\'s Online Privacy Protection Act) in the United States.',
          '  • GDPR provisions related to children in the European Union.',
          '  • The Nigerian Child Rights Act and Cybercrime Act.',
          '  • Any other applicable local and international child protection laws.',
          'Developers are responsible for understanding and following the laws in their regions.',
        ],
      },
      {
        id: 'child-safety-contact',
        title: 'Child Safety Point of Contact',
        description: 'Every app must provide a designated child safety point of contact.',
        steps: [
          'The child safety point of contact must:',
          '  • Be reachable by users, Google Play, and law enforcement.',
          '  • Be responsible for handling all child safety reports and inquiries.',
          '  • Be available to respond to emergencies promptly.',
          '',
          'Citivas Child Safety Contact:',
          '  • Email: hello.bluewavestech@gmail.com',
          '  • Subject Line: [Child Safety Report]',
          'We respond to all child safety reports within 24 hours.',
        ],
      },
      {
        id: 'child-safety-scope',
        title: 'Which Apps Are in Scope?',
        description: 'Understanding which apps fall under this policy.',
        steps: [
          'This policy applies to apps that are:',
          '  • Anonymous or Random Chat apps.',
          '  • Apps in the Social category.',
          '  • Apps in the Dating category.',
          'Even if your app is not specifically designed for children, if it allows user-generated content or user-to-user interactions, you may still be in scope.',
          'Apps that are age-gated or adult-only are not exempt from these requirements.',
        ],
      },
    ],
  },
