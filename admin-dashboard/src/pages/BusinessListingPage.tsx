...
const mockBusinessListings: BusinessListing[] = [
  {
    id: '1',
    name: 'Eko Atlantic Beach Resort',
    category: 'hotel',
    owner: 'Amina Bello',
    email: 'amina@ekoatlanticresort.com',
  ...
  {
    id: '2',
    name: 'Authentic Nigerian Cuisine',
    category: 'restaurant',
    owner: 'Ahmed Ibrahim',
    email: 'ahmed@nigeriancuisine.com',
    phone: '+234 802 345 6789',
    address: 'Ikoyi, Lagos',
    description: 'Traditional Nigerian dishes with a modern twist in the heart of Lagos.',
    status: 'pending',
    rating: 4.5,
    reviews: 89,
  ...
  {
    id: '3',
    name: 'Zuma Rock Adventure',
    category: 'attraction',
    owner: 'Chidi Okoro',
    email: 'chidi@zumarock.com',
    phone: '+234 803 456 7890',
    address: 'Niger State, near Abuja',
    description: 'Guided tours to the famous Zuma Rock with adventure activities.',
    status: 'approved',
    rating: 4.7,
    reviews: 178,
  ...
  {
    id: '4',
    name: 'Cozy Abuja Apartment',
    category: 'airbnb',
    owner: 'Mohammed Ali',
    email: 'mohammed@abujaapartment.com',
    phone: '+234 804 567 8901',
    address: 'Asokoro, Abuja',
    description: 'Peaceful city retreat perfect for couples and small families.',
    status: 'rejected',
    rating: 4.2,
    reviews: 34,
  ...
  },
  {
    ...
    category: 'shopping',
    owner: 'Palms Investments',
    email: 'admin@palmsmall.com',
    phone: '+234 805 678 9012',
    address: 'Lekki, Lagos',
    description: 'One of the largest shopping malls in Nigeria with entertainment and dining.',
    status: 'suspended',
    rating: 4.6,
    reviews: 892,
